...
// ─────────────────────────────────────────────────────────────────────────────
// Products page — temporarily showing "Coming Soon".
// To restore: comment out this file's export and uncomment ProductsPageFull below.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function ProductsPage() {
  return (
    <ComingSoonLayout
      eyebrow="PCB Products"
      tagline="Our full catalogue of precision-manufactured circuit boards is being prepared. Expect something worth the wait."
      badge="In Production"
    />
  );
}
...
export default function ProductsPageFull() {
  return (
